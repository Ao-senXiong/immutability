...
public class PICOInferenceRealTypeFactory extends BaseInferenceRealTypeFactory
    ...
    private static final List<String> IMMUTABLE_ALIASES =
            Arrays.asList(
    ...
    protected QualifierDefaults createQualifierDefaults() {
        ...
        // i.e. -AuseConservativeDefaultsForUncheckedCode=bytecode (or
        // -AuseDefaultsForUncheckedCode=bytecode)
        //      -AuseOptimisticUncheckedDefaults
        if (checker.hasOption("useOptimisticUncheckedDefaults")) {
            defaults.addUncheckedCodeDefaults(
                    AnnotationBuilder.fromClass(elements, Bottom.class),
                    new TypeUseLocation[] {
            ...
            defaults.addUncheckedCodeDefaults(
                    ...
                    new TypeUseLocation[] {TypeUseLocation.UPPER_BOUND, TypeUseLocation.PARAMETER});
        }
    ...
    public AnnotatedTypeMirror getTypeOfExtendsImplements(Tree clause) {
        ...
        // by reaching this line TypesUtils::isAnonymous is already not working: it shouldn't check
        // anonymous class!
        ...
        // this.getTypeDeclarationBounds(fromTypeTree.getUnderlyingType());
