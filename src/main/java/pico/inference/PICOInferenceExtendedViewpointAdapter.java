...
public class PICOInferenceExtendedViewpointAdapter extends PICOInferenceViewpointAdapter
    ...
    /**
     * (Extended behaviour) viewpoint adapt super clause to its class declaration. Class declaration
     * acts like receiver.
     *
     ...
     */
    public void viewpointAdaptSuperClause(
            AnnotatedTypeMirror.AnnotatedDeclaredType classType,
            Element superEle,
            AnnotatedTypeMirror.AnnotatedDeclaredType superType) {
        //        AnnotatedTypeMirror adapted = combineTypeWithType(classType, superType);
        AnnotationMirror adapted =
                combineAnnotationWithAnnotation(
                        extractAnnotationMirror(classType), extractAnnotationMirror(superType));
