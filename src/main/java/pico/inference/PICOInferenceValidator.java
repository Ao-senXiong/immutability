...
public class PICOInferenceValidator extends InferenceValidator {
    ...
    public Void visitDeclared(AnnotatedDeclaredType type, Tree tree) {
        ...
        //        // TODO for defaulted super clause: should top anno be checked? (see
        // shouldCheckTopLevelDeclaredOrPrimitiveType())
        //        if (defaultType.getAnnotationInHierarchy(READONLY) == null &&
        // !PICOTypeUtil.isEnumOrEnumConstant(defaultType)) {
        ...
        ((PICOInferenceVisitor) visitor)
                .mainCannotInferTo(type, POLY_MUTABLE, "cannot.infer.poly", tree);
    ...
    protected boolean shouldCheckTopLevelDeclaredOrPrimitiveType(
        ...
        if (infer) {
            ...
            if ((tree.getKind() == Tree.Kind.IDENTIFIER
                    ...
                    && PICOAnnotatedTypeFactory.PICOSuperClauseAnnotator.isSuperClause(
