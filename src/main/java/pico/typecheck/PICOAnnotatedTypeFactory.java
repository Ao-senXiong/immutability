...
public class PICOAnnotatedTypeFactory
        extends InitializationAnnotatedTypeFactory<PICOValue, PICOStore, PICOTransfer, PICOAnalysis>
    ...
    protected Set<? extends AnnotationMirror> getDefaultTypeDeclarationBounds() {
        Set<AnnotationMirror> frameworkDefault =
                new HashSet<>(super.getDefaultTypeDeclarationBounds());
    ...
    private Set<AnnotationMirror> replaceAnnotationInHierarchy(
            Set<AnnotationMirror> set, AnnotationMirror mirror) {
