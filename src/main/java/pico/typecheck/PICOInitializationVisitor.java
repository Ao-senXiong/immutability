...
/**
 * The InitializationVisitor for the PICO type system. This class is mainly created to override createTypeFactory()
 * method for the purpose of using PICOInitializationAnnotatedTypeFactory.
 */
